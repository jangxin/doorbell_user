...
- (void)initValues{
    ...
    self.strLong = @"40";
    self.devicetoken = @"";
    self.shareAdminModel = [[AdminModel alloc] init];
    _strCountryCode = @"+47";
    _strISOCode = @"NO";
    _mFlag =    [UIImage imageNamed: [NSString stringWithFormat:@"CountryPicker.bundle/%@", _strISOCode]];
    _dictCountryCodes = [NSDictionary dictionaryWithObjectsAndKeys:
                         @[@"Afghanistan",@"93"],@"AF",
